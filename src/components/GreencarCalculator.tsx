...
export function GreencarCalculator() {
  ...
  const result =
    ratesReady && hasDistance
      ? calcGreencar({ upTo30, upTo100, over100 }, distanceKm)
      : null
      ...
      <div className="rounded-lg bg-white border border-gray-200 p-6 space-y-4">
        <div className="space-y-3">
          <p className="text-xs text-gray-400">
            구간별 단가 — 그린카 앱 → 차량 선택 → 요금 안내에서 확인
          </p>

          <div>
            <label htmlFor="greencar-upto30" className="block text-sm text-gray-700 mb-1.5">
              1 ~ 30km 단가
            </label>
          ...
          <div>
            <label htmlFor="greencar-upto100" className="block text-sm text-gray-700 mb-1.5">
              30 ~ 100km 단가
            </label>
            <div className="relative">
              <input
          ...
          <div>
            <label htmlFor="greencar-over100" className="block text-sm text-gray-700 mb-1.5">
              100km ~ 단가
            </label>
            <div className="relative">
              <input
        ...
        <div>
          <label htmlFor="greencar-distance" className="block text-sm text-gray-700 mb-1.5">
            주행거리
          </label>
          <div className="relative">
            <input
              id="greencar-distance"
              type="number"
              inputMode="numeric"
              min="1"
              placeholder="예: 120"
